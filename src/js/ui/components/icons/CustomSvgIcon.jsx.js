...
module.exports = function () {
    ...
    var React = require('react'),
        ...
        icons = {
            ...
            'opposition': (
                <g>
                    <line y1="12" x1="4" y2="12" x2="21" strokeWidth="2" stroke="#ddd"/>
                    <circle fill="#eee" cx="4" cy="12" r="3"/>
                    <circle fill="#eee" cx="13" cy="12" r="2"/>
                    <circle fill="#eee" cx="21" cy="12" r="2"/>
                </g>
            ),
            'max-elongation': (
                <g>
                    <path id="svg_2" d="m4,9l0,8l17,0l-17,-8z" stroke="#ddd" strokeWidth="2" fill="none"/>
                    <circle fill="#eee" cx="4" cy="9" r="3" id="svg_3"/>
                    <circle fill="#eee" cx="4" cy="17" r="2" id="svg_4"/>
                    <circle fill="#eee" cx="21" cy="17" r="2" id="svg_5"/>
                </g>
            ),
            'diameter': <path fill="#eee"
            ...
            'moon': <path fill="#eee" fill-opacity="1" stroke-opacity="1" stroke="null"
