var fs = require('fs'),
    ...
    encoded = btoa(String.fromCharCode.apply(null, new Uint8Array(new Float32Array(stars).buffer)));

fs.writeFileSync('./data/stars.json', JSON.stringify(encoded));
